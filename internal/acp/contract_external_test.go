...
func TestExternalACPClientAdmissionMatrix(t *testing.T) {
	inputs := []map[string]any{
		...
		{"jsonrpc": "2.0", "id": 11, "method": "session/prompt", "params": map[string]any{"sessionId": "text", "prompt": []any{map[string]any{"type": "audio", "data": "aGk=", "mimeType": "audio/wav"}}}},
		{"jsonrpc": "2.0", "id": 12, "method": "session/prompt", "params": map[string]any{"sessionId": "text", "prompt": []any{map[string]any{"type": "embedded_context", "text": "context"}}}},
		...
		{"jsonrpc": "2.0", "id": 14, "method": "session/prompt", "params": map[string]any{"sessionId": "text", "prompt": []any{map[string]any{"type": "text", "text": "   "}}}},
		{"jsonrpc": "2.0", "id": 15, "method": "session/prompt", "params": map[string]any{"sessionId": "image", "prompt": []any{map[string]any{"type": "image", "data": "not-base64", "mimeType": "image/png"}}}},
		{"jsonrpc": "2.0", "id": 16, "method": "session/prompt", "params": map[string]any{"sessionId": "image", "prompt": []any{map[string]any{"type": "image", "data": "aGk=", "mimeType": "image/svg+xml"}}}},
	}
