import { EntryGroup, EntryTree, isJsExpr, type EntryOptions } from '@shutu-ai/cordis-plugin-loader'
 ...
 * (`shutu --dump-config`) parses and prints exactly the dialect this include
 * mounts.
 */
 ...
 * (`shutu --dump-config`) so a dump can never drift from what boots. The input
