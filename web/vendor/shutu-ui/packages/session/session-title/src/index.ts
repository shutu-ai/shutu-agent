 ...
 * @module @shutu-ai/session-title
 */

import { Context, FiberState, Service, type Fiber } from '@shutu-ai/cordis'
import z from '@shutu-ai/schemastery'
import { z as zod } from 'zod'
import type { Branded } from '@shutu-ai/brand'
import { assertNever, deepFreeze, isAgentLoopRequest } from '@shutu-ai/llm'
import type { GenerateOptions } from '@shutu-ai/llm'
import type {
  Session,
  SessionEvent,
} from '@shutu-ai/session'
