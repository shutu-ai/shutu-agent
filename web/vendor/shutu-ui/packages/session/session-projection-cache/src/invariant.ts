/**
 * Package-owned invariant companion for `@shutu-ai/session-projection-cache`.
 * @module @shutu-ai/session-projection-cache/invariant
 */
...
const PACKAGE_NAME = '@shutu-ai/session-projection-cache'
