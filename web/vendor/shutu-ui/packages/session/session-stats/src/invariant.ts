/**
 * Package-owned invariant companion for `@shutu-ai/session-stats`.
 * @module @shutu-ai/session-stats/invariant
 */
...
const PACKAGE_NAME = '@shutu-ai/session-stats'
 ...
 * ids) are owned and runtime-checked by shutu-agent-loop and the session
 * surface, not here.
 */
