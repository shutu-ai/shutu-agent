 ...
 * (`deriveStats` in shutu-client-ui-conversation, that fold's whole-window
 ...
 *
 * @module @shutu-ai/session-stats/projection
 */

import { z } from 'zod'
import { isTokenDelta } from '@shutu-ai/llm/message'
import type { ProjectionDefinition } from '@shutu-ai/session-projection'
