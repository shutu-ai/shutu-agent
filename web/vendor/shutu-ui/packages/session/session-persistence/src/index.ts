 ...
 * @module @shutu-ai/session-persistence
 */

import { Context, Service } from '@shutu-ai/cordis'
import { SessionPreparation } from '@shutu-ai/session'
import type { SessionEvent, SessionId, SessionHeader } from '@shutu-ai/session'
import type { SessionPersistenceRevision } from './revision.ts'

// Re-export the metadata vocabulary so Consumers import it from the Service Definition.
export type { SessionHeader } from '@shutu-ai/session'
