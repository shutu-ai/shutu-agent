 ...
 * @module @shutu-ai/session-persistence/coordinator
 */
...
import type { Session, SessionEvent, SessionId, SessionHeader } from '@shutu-ai/session'
...
export class PersistenceCoordinator<TornMarker = unknown> {
  ...
  private installWritePath(): void {
    ...
    // sessions (mirrors shutu-invariants).
