/**
 * Package-owned invariant companion for `@shutu-ai/session-projection`.
 * @module @shutu-ai/session-projection/invariant
 */
...
const PACKAGE_NAME = '@shutu-ai/session-projection'
