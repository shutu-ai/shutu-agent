/**
 * Package-owned invariant companion for `@shutu-ai/client-ui-commands`.
 * @module @shutu-ai/client-ui-commands/invariant
 */
...
const PACKAGE_NAME = '@shutu-ai/client-ui-commands'
