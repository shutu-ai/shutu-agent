/**
 * Package-owned invariant companion for `@shutu-ai/client-ui-trajectory`.
 * @module @shutu-ai/client-ui-trajectory/invariant
 */
...
const PACKAGE_NAME = '@shutu-ai/client-ui-trajectory'
