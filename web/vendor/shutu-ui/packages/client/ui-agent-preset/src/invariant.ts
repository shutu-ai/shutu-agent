/**
 * Package-owned invariant companion for `@shutu-ai/client-ui-agent-preset`.
 * @module @shutu-ai/client-ui-agent-preset/invariant
 */
...
const PACKAGE_NAME = '@shutu-ai/client-ui-agent-preset'
