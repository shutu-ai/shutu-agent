/**
 * Package-owned invariant companion for `@shutu-ai/client-ui-directory-picker-native`.
 * @module @shutu-ai/client-ui-directory-picker-native/invariant
 */
...
const PACKAGE_NAME = '@shutu-ai/client-ui-directory-picker-native'
