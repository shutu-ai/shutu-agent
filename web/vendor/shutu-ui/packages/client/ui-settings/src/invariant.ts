/**
 * Package-owned invariant companion for `@shutu-ai/client-ui-settings`.
 * @module @shutu-ai/client-ui-settings/invariant
 */
...
const PACKAGE_NAME = '@shutu-ai/client-ui-settings'
