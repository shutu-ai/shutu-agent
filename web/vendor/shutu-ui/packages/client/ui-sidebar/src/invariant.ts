/**
 * Package-owned invariant companion for `@shutu-ai/client-ui-sidebar`.
 * @module @shutu-ai/client-ui-sidebar/invariant
 */
...
const PACKAGE_NAME = '@shutu-ai/client-ui-sidebar'
