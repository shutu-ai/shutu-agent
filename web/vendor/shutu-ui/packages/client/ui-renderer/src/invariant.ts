/**
 * Package-owned invariant companion for `@shutu-ai/client-ui-renderer`.
 * @module @shutu-ai/client-ui-renderer/invariant
 */
...
const PACKAGE_NAME = '@shutu-ai/client-ui-renderer'
