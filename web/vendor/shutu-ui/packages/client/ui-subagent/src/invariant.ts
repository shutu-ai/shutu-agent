/**
 * Package-owned invariant companion for `@shutu-ai/client-ui-subagent`.
 * @module @shutu-ai/client-ui-subagent/invariant
 */
...
const PACKAGE_NAME = '@shutu-ai/client-ui-subagent'
