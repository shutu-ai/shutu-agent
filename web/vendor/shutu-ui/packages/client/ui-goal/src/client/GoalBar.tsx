...
import type { GoalSnapshot } from '@shutu-ai/goal/client'
import {
...
import type { PropsLocale } from '@shutu-ai/client-ui-slots'
...
export type GoalDockProps = import('@shutu-ai/client-ui-slots').PropsRuntime<'conversation.input.dock'> & GoalBarActions & PropsLocale<'goal'>
