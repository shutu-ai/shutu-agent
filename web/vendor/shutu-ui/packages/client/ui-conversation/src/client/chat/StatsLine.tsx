...
import { Tooltip } from '@shutu-ai/client-ui-primitives'
import type { ConversationSnapshot, UseProjection } from '@shutu-ai/client-runtime/client'
import type { SnapshotSelectorHook } from '@shutu-ai/client-ui-slots'
// Type-only: merges the sessionStats key into SessionProjectionMap for useProjection.
import type {} from '@shutu-ai/session-stats/client'
import type { ContextPressureProjection, TokenUsageProjection } from '@shutu-ai/token-meter/client'
