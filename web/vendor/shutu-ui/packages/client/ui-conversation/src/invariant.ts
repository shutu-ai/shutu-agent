/**
 * Package-owned invariant companion for `@shutu-ai/client-ui-conversation`.
 * @module @shutu-ai/client-ui-conversation/invariant
 */
...
const PACKAGE_NAME = '@shutu-ai/client-ui-conversation'
