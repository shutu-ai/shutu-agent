 ...
 */
import type { ConnectionHandle } from '@shutu-ai/api-remotes/client'
...
import type {} from '@shutu-ai/client-ui-settings/client'
// Type-only: pulls the ctx.remote merge and the forwarded-event key face
// (the settings invalidation rides the allowlist) into this program.
import type {} from '@shutu-ai/api-remotes/client'
import type { ClientContext, SessionFace } from '@shutu-ai/client-runtime/client'
import type { CommandUiContract, SelectOption } from '@shutu-ai/client-ui-commands/client'
import type { ClientSessionContext } from '@shutu-ai/client-ui-input-trigger/client'
import type { PermissionSelect } from '@shutu-ai/permission-presets/client'
