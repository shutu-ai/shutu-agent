/**
 * Package-owned invariant companion for `@shutu-ai/client-ui-permission-presets`.
 * @module @shutu-ai/client-ui-permission-presets/invariant
 */
...
const PACKAGE_NAME = '@shutu-ai/client-ui-permission-presets'
