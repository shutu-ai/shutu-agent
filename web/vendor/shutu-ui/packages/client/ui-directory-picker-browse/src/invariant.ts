/**
 * Package-owned invariant companion for `@shutu-ai/client-ui-directory-picker-browse`.
 * @module @shutu-ai/client-ui-directory-picker-browse/invariant
 */
...
const PACKAGE_NAME = '@shutu-ai/client-ui-directory-picker-browse'
