/**
 * Package-owned invariant companion for `@shutu-ai/client-ui-primitives`.
 * @module @shutu-ai/client-ui-primitives/invariant
 */
...
const PACKAGE_NAME = '@shutu-ai/client-ui-primitives'
