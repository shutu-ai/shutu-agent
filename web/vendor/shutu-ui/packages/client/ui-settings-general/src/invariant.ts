/**
 * Package-owned invariant companion for `@shutu-ai/client-ui-settings-general`.
 * @module @shutu-ai/client-ui-settings-general/invariant
 */
...
const PACKAGE_NAME = '@shutu-ai/client-ui-settings-general'
