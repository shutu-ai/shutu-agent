/**
 * Package-owned invariant companion for `@shutu-ai/client-ui-input-trigger`.
 * @module @shutu-ai/client-ui-input-trigger/invariant
 */
...
const PACKAGE_NAME = '@shutu-ai/client-ui-input-trigger'
