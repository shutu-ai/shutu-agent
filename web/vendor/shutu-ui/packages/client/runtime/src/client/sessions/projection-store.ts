...
// (`/types`, zero imports), never the package root: the root's shutu-agent →
// shutu-session chain would drag the host `Context.sessions` merge into the
...
export type { SessionProjectionMap } from '@shutu-ai/session-projection/types'
