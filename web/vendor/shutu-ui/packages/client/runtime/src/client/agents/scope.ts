 ...
 * Agent's identity. The mechanism mirrors the host `shutu-scope` architecture
...
import type { SessionId } from '@shutu-ai/api-remotes/client'
import type { TypertClientRemote, TypertRemoteScopeApi } from '@shutu-ai/typert-protocol'
...
const kScope = Symbol('shutu.client.scope')
