...
import type { ConnectionHandle, SessionId } from '@shutu-ai/api-remotes/client'
...
import type { TypertContext } from '@shutu-ai/typert-protocol'
import type { MaybeSnapshotSelectorHook, SnapshotSelectorHook } from '@shutu-ai/client-ui-slots'
...
export { isAppendSurfaceEvent, isReplacementSurfaceEvent } from '@shutu-ai/session/surface'
...
// shutu-client-ui-settings (see that package's settings-scope.ts).
export type {
...
export type { SubagentAddress, JobView } from '@shutu-ai/client-connection/client'
...
export type { SessionId } from '@shutu-ai/client-connection/client'
...
declare module '@shutu-ai/client-ui-slots' {
  /**
