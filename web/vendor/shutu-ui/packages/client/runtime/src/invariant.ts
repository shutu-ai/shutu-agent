/**
 * Package-owned invariant companion for `@shutu-ai/client-runtime`.
 * @module @shutu-ai/client-runtime/invariant
 */
...
import type { SlotMap } from '@shutu-ai/client-ui-slots'
import type { InvariantInstaller } from '@shutu-ai/invariants'

const PACKAGE_NAME = '@shutu-ai/client-runtime'
