 ...
 * determinism
 * lives host-side — the pre-step boundary (`shutu-tool-skill`) recognizes a
...
import type { ConnectionHandle, SessionId, SkillEntry } from '@shutu-ai/api-remotes/client'
import type { ClientContext, ISessions } from '@shutu-ai/client-runtime/client'
import type { InputTriggerServiceContract, InputTriggerSource } from '@shutu-ai/client-ui-input-trigger/client'
// Type-only: pulls the locale plugin's Context merge (ctx.locale).
import type {} from '@shutu-ai/client-locale/client'
...
export function apply(ctx: ClientContext): void {
  ...
  const source: InputTriggerSource = {
    ...
    onPick({ candidate }) {
      ...
      // pre-step boundary (shutu-tool-skill) recognizes the leading /name and
