 ...
 * @module
 */
import { resolveWorkspacePath } from '@shutu-ai/client-runtime/client'
import type { TerminalBlockLabels, TerminalBlockProps } from '@shutu-ai/client-ui-primitives'
 ...
 * `ToolResultNode.call`/`callView` in shutu-client-runtime), leaving a terminal
