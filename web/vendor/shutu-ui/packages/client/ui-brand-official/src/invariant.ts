/**
 * Package-owned invariant companion for `@shutu-ai/client-ui-brand-official`.
 * @module @shutu-ai/client-ui-brand-official/invariant
 */
...
const PACKAGE_NAME = '@shutu-ai/client-ui-brand-official'
