/**
 * Package-owned invariant companion for `@shutu-ai/client-ui-deliverables`.
 * @module @shutu-ai/client-ui-deliverables/invariant
 */
...
const PACKAGE_NAME = '@shutu-ai/client-ui-deliverables'
