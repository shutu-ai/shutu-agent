/**
 * Package-owned invariant companion for `@shutu-ai/client-ui-settings-plugins`.
 * @module @shutu-ai/client-ui-settings-plugins/invariant
 */
...
const PACKAGE_NAME = '@shutu-ai/client-ui-settings-plugins'
