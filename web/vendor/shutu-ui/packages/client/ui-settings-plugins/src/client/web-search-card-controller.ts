...
import type { IApiClient } from '@shutu-ai/client-connection/client'
import type { SettingsScope, SettingsScopeSnapshot, SnapshotStore } from '@shutu-ai/client-runtime/client'
import {
