...
import type { ClientContext, SettingsScope } from '@shutu-ai/client-runtime/client'
...
export type { Translate, TranslateNS } from '@shutu-ai/client-ui-slots'
...
export class LocaleRuntime {
   ...
   * different browser sharing the same SHUTU home. Only the render notification
