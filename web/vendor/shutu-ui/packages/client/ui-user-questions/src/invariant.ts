/**
 * Package-owned invariant companion for `@shutu-ai/client-ui-user-questions`.
 * @module @shutu-ai/client-ui-user-questions/invariant
 */
...
const PACKAGE_NAME = '@shutu-ai/client-ui-user-questions'
