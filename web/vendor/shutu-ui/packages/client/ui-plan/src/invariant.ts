/**
 * Package-owned invariant companion for `@shutu-ai/client-ui-plan`.
 * @module @shutu-ai/client-ui-plan/invariant
 */
...
const PACKAGE_NAME = '@shutu-ai/client-ui-plan'
 ...
 * audited by shutu-plan-mode, while the control is a slot effect whose
