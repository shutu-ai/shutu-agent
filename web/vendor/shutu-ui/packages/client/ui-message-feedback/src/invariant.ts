/**
 * Package-owned invariant companion for `@shutu-ai/client-ui-message-feedback`.
 * @module @shutu-ai/client-ui-message-feedback/invariant
 */
...
const PACKAGE_NAME = '@shutu-ai/client-ui-message-feedback'
