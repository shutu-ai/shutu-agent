...
import type { ModelSelection, SessionModels } from '@shutu-ai/api-remotes/client'
import type { ClientContext } from '@shutu-ai/client-runtime/client'
import type { CommandUiContract, SelectOption } from '@shutu-ai/client-ui-commands/client'
// Type-only: pulls the ui-conversation SlotMap merge (the input.model seat).
import type {} from '@shutu-ai/client-ui-conversation/client'
// Type-only: pulls the locale plugin's Context merge (ctx.locale).
import type {} from '@shutu-ai/client-locale/client'
import type { TranslateNS } from '@shutu-ai/client-ui-slots'
