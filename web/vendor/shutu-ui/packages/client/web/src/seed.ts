...
import * as Cordis from '@shutu-ai/cordis'
import * as UiSlots from '@shutu-ai/client-ui-slots'
import * as UiPrimitives from '@shutu-ai/client-ui-primitives'
...
export function getStaticModules(): Record<string, unknown> {
  ...
  return {
    ...
    '@shutu-ai/cordis': Cordis,
    '@shutu-ai/client-ui-slots': UiSlots,
    '@shutu-ai/client-ui-primitives': UiPrimitives,
