 ...
 * @module @shutu-ai/client-web/src/loader-status
 */
import type { FiberState } from '@shutu-ai/cordis'
 ...
 * while retaining its type (same rationale as shutu-tool-cordis's mirror).
 */
