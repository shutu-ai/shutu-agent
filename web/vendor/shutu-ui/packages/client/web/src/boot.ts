 ...
 * @module @shutu-ai/client-web/src/boot
 */
import { Context } from '@shutu-ai/cordis'
import Loader from '@shutu-ai/cordis-plugin-loader'
import type {
  BootManifest, ClientModuleCreateOptions, ClientModuleSystem, ShutuWindow,
} from '@shutu-ai/client-modules/client'
import type {} from '@shutu-ai/client-ui-renderer/client'
...
export class AppWebEntry {
  ...
  async run(): Promise<void> {
    try {
      const win = globalThis as ShutuWindow
