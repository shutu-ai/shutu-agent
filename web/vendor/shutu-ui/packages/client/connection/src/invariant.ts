/**
 * Package-owned invariant companion for `@shutu-ai/client-connection`.
 * @module @shutu-ai/client-connection/invariant
 */
...
const PACKAGE_NAME = '@shutu-ai/client-connection'
