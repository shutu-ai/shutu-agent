...
import type {} from '@shutu-ai/attachment'
// Activates the webServer Context merge used below.
import type { WebRoute, WebUpgradeRoute } from '@shutu-ai/host-webserver'
import { toFetchHandler } from '@shutu-ai/host-apiproxy'
...
export interface ConnectionConfig {
   ...
   * by (the shutu CLI derives the machine's LAN IP literals itself). An entry
