/**
 * Package-owned invariant companion for `@shutu-ai/client-ui-attachment`.
 * @module @shutu-ai/client-ui-attachment/invariant
 */
...
const PACKAGE_NAME = '@shutu-ai/client-ui-attachment'
