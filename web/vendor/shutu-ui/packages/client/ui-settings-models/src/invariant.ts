/**
 * Package-owned invariant companion for `@shutu-ai/client-ui-settings-models`.
 * @module @shutu-ai/client-ui-settings-models/invariant
 */
...
const PACKAGE_NAME = '@shutu-ai/client-ui-settings-models'
