/**
 * Package-owned invariant companion for `@shutu-ai/client-ui-workspace`.
 * @module @shutu-ai/client-ui-workspace/invariant
 */
...
const PACKAGE_NAME = '@shutu-ai/client-ui-workspace'
