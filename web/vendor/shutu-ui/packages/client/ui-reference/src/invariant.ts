/**
 * Package-owned invariant companion for `@shutu-ai/client-ui-reference`.
 * @module @shutu-ai/client-ui-reference/invariant
 */
...
const PACKAGE_NAME = '@shutu-ai/client-ui-reference'
