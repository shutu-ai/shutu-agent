 ...
 * @module @shutu-ai/message-feedback
 */

import { Buffer } from 'node:buffer'
import { randomUUID } from 'node:crypto'
import { Context, Service } from '@shutu-ai/cordis'
import s from '@shutu-ai/schemastery'
import { deriveEventMessage, isAppendSurfaceEvent } from '@shutu-ai/session/surface'
import type { SessionHeader, SessionId } from '@shutu-ai/session/types'
import type { SessionInspection } from '@shutu-ai/session-persistence'
import type { KvTable } from '@shutu-ai/storage-domain'
