 ...
 *
 * Declared here (not in shutu-tools) because it is part of {@link GenerateOptions};
 * shutu-tools' ToolDefinition and shutu-system-prompt's PromptAssembly both import
...
export interface GenerateOptions {
   ...
   * the derived history (shutu-agent-loop); a hand-built one-shot passes any list.
   */
  messages: Message[]
