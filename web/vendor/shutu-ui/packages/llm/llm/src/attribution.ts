 ...
 * adapters from drifting. See `internal/llm/attribution.go` for the native
 * backend contract.
 *
 * App-attribution vocabulary for provider requests.
 * @module @shutu-ai/llm/attribution
 */
...
/**
 * Shutu Agent's own identity: the default every adapter sends. Deployments
...
export const APP_IDENTITY: AppIdentity = {
  product: 'shutu-agent',
  version,
  url: 'https://github.com/shutu-ai/shutu-agent',
}
