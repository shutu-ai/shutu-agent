/** Package-owned durable retry-event invariants. @module @shutu-ai/llm-retry/invariant */

import type { Context } from '@shutu-ai/cordis'
import type { Session, SessionEvent } from '@shutu-ai/session'
import type { LlmFailure } from '@shutu-ai/llm'
import { MAX_TIMER_DELAY_MS } from '@shutu-ai/timeout'
import type { InvariantFailure, InvariantInstaller } from '@shutu-ai/invariants'
import { providerForOpenStep } from './history.ts'
import type {} from './index.ts'

const PACKAGE_NAME = '@shutu-ai/llm-retry'
