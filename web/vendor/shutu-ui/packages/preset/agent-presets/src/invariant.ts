/**
 * Package-owned invariant companion for `@shutu-ai/agent-presets`.
 * @module @shutu-ai/agent-presets/invariant
 */
...
// joins, and the `agent` field `shutu-agent` merges into its context.
...
import { leakedServices, livePresetMounts } from '@shutu-ai/agent-presets'

const PACKAGE_NAME = '@shutu-ai/agent-presets'
