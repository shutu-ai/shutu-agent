 ...
 * @module @shutu-ai/agent-presets/mount
 */

import { isAbsolute } from 'node:path'
import { pathToFileURL } from 'node:url'
import { Context, type Fiber } from '@shutu-ai/cordis'
import { Include } from '@shutu-ai/cordis-plugin-include'
import type { EntryTree } from '@shutu-ai/cordis-plugin-loader'
import { scopeOf, scopeParentOf, type ScopeKey } from '@shutu-ai/scope'
...
class PresetTree extends Include {
   ...
   * dependencies, so every `@shutu-ai/*` row would fail to import. The
 ...
 * invariant companion's service listener, and `shutu-invariants` is a
