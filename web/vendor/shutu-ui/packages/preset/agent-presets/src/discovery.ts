 ...
 * @module @shutu-ai/agent-presets/discovery
 */

import { readdir, readFile, stat } from 'node:fs/promises'
import { join, resolve } from 'node:path'
import { load } from 'js-yaml'
import { entryListSchema } from '@shutu-ai/cordis-plugin-include'
import { expandHomePath } from '@shutu-ai/home-paths'
 ...
 *
 * This package owns the writable root the way `shutu-skill-filesystem` owns
 * `<shutuHome>/skills`. An app must assemble the SHIPPED root, whose path only
