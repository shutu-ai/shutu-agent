/**
 * Package-owned invariant companion for `@shutu-ai/client-test-runtime`.
 * @module @shutu-ai/client-test-runtime/invariant
 */
...
const PACKAGE_NAME = '@shutu-ai/client-test-runtime'
