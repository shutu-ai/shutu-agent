...
import { foldSurface, isSurfaceEvent, snapshotSessionEvent } from '@shutu-ai/session'
import type { SessionEvent, SessionId, SurfaceEvent, SurfaceEventType } from '@shutu-ai/session'
