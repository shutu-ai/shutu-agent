/**
 * shutu-commands' owned branded id: command lifecycle pairing across the
 * session log, the wire admission response, and client-side flow pairing.
 *
 * The `Branded<B>` primitive lives in `@shutu-ai/brand`; this module
 ...
 * loading the host plugin's Context merges — the `shutu-llm/brand` shape.
 *
 * @module @shutu-ai/commands/brand
 */
