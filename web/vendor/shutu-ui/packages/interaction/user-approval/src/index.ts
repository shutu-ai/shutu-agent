...
import { createUserMessage, type CallId } from '@shutu-ai/llm'
...
declare module '@shutu-ai/cordis' {
  ...
  interface Events {
     ...
     * Scope-filtered dispatch (`@shutu-ai/scope`): agent-scoped listeners receive only that agent.
