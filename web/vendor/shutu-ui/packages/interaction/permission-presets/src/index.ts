 ...
 *
 * @module shutu-permission-presets
 */

import { Context, Service } from '@shutu-ai/cordis'
import z from '@shutu-ai/schemastery'
import { z as zod } from 'zod'
import type { Session, SessionEvent } from '@shutu-ai/session'
import type { SandboxMode } from '@shutu-ai/sandbox'
import { SANDBOX_MODES, effectiveSandboxMode, setSandboxMode } from '@shutu-ai/sandbox-policy'
...
import type {} from '@shutu-ai/shell'
import type { ApprovalPolicy } from '@shutu-ai/user-approval'
import { APPROVAL_POLICIES, effectiveApprovalPolicy, setApprovalPolicy } from '@shutu-ai/user-approval'
import { installSettingsSection, settingsNamespace } from '@shutu-ai/settings'
