/**
 * Shared rendering helpers for the shell tools (`shutu-tool-bash`,
 * `shutu-tool-pwsh`): the exit-status marker contract the tools' renderers
 * emit and the presentation layer parses back.
 * @module @shutu-ai/shell/render
 */
