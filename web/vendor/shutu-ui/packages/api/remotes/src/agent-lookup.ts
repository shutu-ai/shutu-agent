...
import type { Agent, AgentOptions, AgentSetup } from '@shutu-ai/agent'
...
import { TypertLookupFailure } from '@shutu-ai/typert-protocol'
import type {} from '@shutu-ai/typert-registry'
...
export async function inspectApiRemoteSession(
  ...
  if (persistence === undefined) {
    throw new Error('session persistence is not configured (load a shutu-session-persistence backend)')
  }
