 ...
 * @module @shutu-ai/cordis-host-runner/guard
 */

import { Context } from '@shutu-ai/cordis'
import type { Plugin } from '@shutu-ai/cordis'
import { scopeOf } from '@shutu-ai/scope'
import { assertSupportedJsonSchema, defineTool } from '@shutu-ai/tools'
import type { ToolDefinition } from '@shutu-ai/tools'
...
function sandboxContext(ctx: Context, reportFailure: (error: Error) => void): Context {
  ...
  // (`@shutu-ai/cordis-client-runner`, whose CTX_VERBS names this one its
