 ...
 * @module @shutu-ai/cordis-host-runner
 */
...
import type { JsonValue } from '@shutu-ai/session/types'
...
function missingPluginMessage(id: CordisDynamicPluginId): string {
  return `no dynamic plugin "${id}" in this process — it may have been removed or lost on SHUTU restart`
}
