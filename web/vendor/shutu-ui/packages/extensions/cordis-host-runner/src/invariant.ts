/**
 * Package-owned invariant companion for `@shutu-ai/cordis-host-runner`.
 * @module @shutu-ai/cordis-host-runner/invariant
 */
...
const PACKAGE_NAME = '@shutu-ai/cordis-host-runner'
