/**
 * Package-owned invariant companion for `@shutu-ai/cordis-client-runner`.
 * @module @shutu-ai/cordis-client-runner/invariant
 */
...
const PACKAGE_NAME = '@shutu-ai/cordis-client-runner'
