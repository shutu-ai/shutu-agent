 ...
 *
 * @module @shutu-ai/system-prompt
 */

import { Context, Service } from '@shutu-ai/cordis'
import z from '@shutu-ai/schemastery'
import { AnonymousEntries, NamedEntries, ScopedLayers, scopeTarget } from '@shutu-ai/scope'
import type { ScopeKey, ScopeLayer, Scoped } from '@shutu-ai/scope'
import type { ContextSnapshotSection, ToolSchema } from '@shutu-ai/llm'
...
declare module '@shutu-ai/cordis' {
  ...
  interface Events {
     ...
     * Scope-filtered dispatch (`@shutu-ai/scope`): scoped listeners
