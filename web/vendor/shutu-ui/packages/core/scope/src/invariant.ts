/** Package-owned scoped-dispatch invariants. @module @shutu-ai/scope/invariant */

import type { Context } from '@shutu-ai/cordis'
import type { InvariantInstaller } from '@shutu-ai/invariants'
import { carrierKeyOf, isScopeCarrier } from '@shutu-ai/scope'
import { scopedSubjectResolverFor } from './scoped-events.generated.ts'

const PACKAGE_NAME = '@shutu-ai/scope'
