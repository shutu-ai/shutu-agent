/** Package-owned agent lifecycle invariants. @module @shutu-ai/agent/invariant */

import type { Context } from '@shutu-ai/cordis'
import type { InvariantInstaller } from '@shutu-ai/invariants'
import type { Agent, AgentStatus } from '@shutu-ai/agent'

const PACKAGE_NAME = '@shutu-ai/agent'
