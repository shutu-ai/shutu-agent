 ...
 * companion beside `@shutu-ai/invariants` to enable the checks.
 *
 * @module @shutu-ai/session/invariant
 */

import type { Context } from '@shutu-ai/cordis'
import { assertNever } from '@shutu-ai/llm'
import type { CallId } from '@shutu-ai/llm'
...
const PACKAGE_NAME = '@shutu-ai/session'
