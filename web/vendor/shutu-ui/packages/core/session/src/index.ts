 ...
 *
 * @module @shutu-ai/session
 */

import { Context, Service } from '@shutu-ai/cordis'
import { isAbsolute } from 'node:path'
import { deepFreeze } from '@shutu-ai/llm'
import { scopeOf, scopeTarget } from '@shutu-ai/scope'
import type { Scoped } from '@shutu-ai/scope'
import type { Message } from '@shutu-ai/llm'
import { SESSION_FORMAT_VERSION, SessionId } from './types.ts'
import type { TypertLookup } from '@shutu-ai/typert-protocol'
...
export type { AssistantMessage, ToolResultMessage, UserMessage } from '@shutu-ai/llm'
...
declare module '@shutu-ai/cordis' {
  ...
  interface Events {
     ...
     * Scope-filtered dispatch (`@shutu-ai/scope`): agent-scoped listeners
     * receive only sessions entered through that agent's context.
     * @param session - the session just entered and announced.
     * @shutuScopeScan unsupported
     * @mode emit
     */
     ...
     * Scope-filtered dispatch (`@shutu-ai/scope`) reuses the owner scope.
     ...
     * (`@shutu-ai/scope`) reuses the session's owner scope.
...
export class SessionStore extends Service {
  ...
  constructor(ctx: Context) {
    ...
    ctx.inject(['typert'], (typeCtx) => {
      typeCtx.typert.lookups.register('session', {
        parameter: 'session',
        wire: 'sessionId',
        hostTypeSymbol: '@shutu-ai/session#Session',
   ...
   * `shutu-agent-loop`'s creation transaction).
   *
