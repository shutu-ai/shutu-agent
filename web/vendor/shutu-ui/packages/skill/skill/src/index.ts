 ...
 * Concrete
 * providers such as `@shutu-ai/skill-filesystem` decide where skills come
 ...
 *
 * @module @shutu-ai/skill
 */

import { Context, Service } from '@shutu-ai/cordis'
import { assertNever } from '@shutu-ai/llm'
import { NamedEntries, ScopedLayers, scopeChainOf, scopeOf } from '@shutu-ai/scope'
import type { ScopeKey, ScopeLayer } from '@shutu-ai/scope'
import z from '@shutu-ai/schemastery'
import type Schema from '@shutu-ai/schemastery'
...
export type SkillSource = 'project-shutu' | 'project-agents' | 'runtime' | 'user-shutu' | 'user-agents' | 'custom' | 'bundled' | (string & {})
