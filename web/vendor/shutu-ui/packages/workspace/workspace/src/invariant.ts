/**
 * Package-owned invariant companion for `@shutu-ai/workspace`.
 * @module @shutu-ai/workspace/invariant
 */

import type { Context } from '@shutu-ai/cordis'
import type { InvariantInstaller } from '@shutu-ai/invariants'
import type { DomainChanged } from '@shutu-ai/storage-domain'
import { WorkspaceId } from '@shutu-ai/workspace'

const PACKAGE_NAME = '@shutu-ai/workspace'
