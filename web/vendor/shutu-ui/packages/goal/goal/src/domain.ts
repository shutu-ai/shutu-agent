 ...
 * these declarations pull shutu-agent, shutu-llm, and cordis into the program —
 * the one-program-per-side layout forbids that on client aggregates.
 * @module @shutu-ai/goal
 */
...
declare module '@shutu-ai/cordis' {
  interface Events {
     ...
     * @mode emit
     */
    'goal/changed'(this: import('@shutu-ai/scope').Scoped<Agent>, payload: { agent: Agent; change: GoalChanged }): void
  }
}
