 ...
 *
 * @module @shutu-ai/session-reference
 */
...
import { Remote, TypertRemoteService } from '@shutu-ai/typert-protocol'
import { createUserMessage, freezeMessage } from '@shutu-ai/llm'
import type { ContentBlock, UserMessage } from '@shutu-ai/llm'
import type { SessionId } from '@shutu-ai/session'
import type { SessionSurfaceSnapshot, SessionTitleObservationResult } from '@shutu-ai/session-query'
import {
