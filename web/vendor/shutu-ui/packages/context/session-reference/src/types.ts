 ...
 * @module @shutu-ai/session-reference/types
 */

import type { UserMessage } from '@shutu-ai/llm/message'
import type { ContentBlock } from '@shutu-ai/llm/types'
import type { SessionId } from '@shutu-ai/session/types'
...
export interface SessionReferenceMentionCandidate extends SessionReferenceCandidate {
  /** Canonical `@[label](shutu-session:…)` mention serialized into the prompt draft. */
  mention: string
}
