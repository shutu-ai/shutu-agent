/**
 * Package-owned invariant companion for `@shutu-ai/session-reference`.
 * @module @shutu-ai/session-reference/invariant
 */
...
const PACKAGE_NAME = '@shutu-ai/session-reference'
