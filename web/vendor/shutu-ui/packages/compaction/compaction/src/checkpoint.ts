 ...
 *
 * The seam itself lives in `@shutu-ai/compaction`, which re-exports these
 ...
 * `shutu-commands/brand` shape.
 *
 * @module @shutu-ai/compaction/checkpoint
 */

import type { MessageSource } from '@shutu-ai/llm/message'
