/** Package-owned compaction log-stream invariants. @module @shutu-ai/compaction/invariant */

import type { Context } from '@shutu-ai/cordis'
import { isReplacementSurfaceEvent } from '@shutu-ai/session'
...
const PACKAGE_NAME = '@shutu-ai/compaction'
