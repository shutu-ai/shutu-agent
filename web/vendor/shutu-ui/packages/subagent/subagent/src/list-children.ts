...
import type { Session, SessionEvent, SessionHeader, SessionId } from '@shutu-ai/session'
import type { SessionPersistence } from '@shutu-ai/session-persistence'
import type { SessionProjectionRegistry } from '@shutu-ai/session-projection'
import type { SessionProjectionCache } from '@shutu-ai/session-projection-cache'
...
async function prepareListing(
  ...
  if (projections === undefined) {
    throw new SubagentError(
      'listing subagents requires the sessionProjections registry (load @shutu-ai/session-projection)',
  ...
  if (sessions === undefined) {
    throw new SubagentError(
      'listing subagents requires the session store (load @shutu-ai/session)',
