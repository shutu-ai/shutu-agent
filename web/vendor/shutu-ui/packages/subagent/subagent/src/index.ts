 ...
 * (`@shutu-ai/subagent-spawn-in-process`, `-fork`, `-acp`) and the model-facing
 * consumer (`@shutu-ai/tool-subagent`) are separate packages.
 *
...
import { assertObjectJsonSchema } from '@shutu-ai/tools'
import type { ContentBlock, MessageId } from '@shutu-ai/llm'
import type { Agent } from '@shutu-ai/agent'
import type { SessionId } from '@shutu-ai/session'
import type {
