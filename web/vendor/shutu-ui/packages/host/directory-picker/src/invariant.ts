/** Package-owned invariant companion for the directory-picker seam. @module @shutu-ai/host-directory-picker/invariant */

import type { Context } from '@shutu-ai/cordis'
import type { InvariantInstaller } from '@shutu-ai/invariants'

const PACKAGE_NAME = '@shutu-ai/host-directory-picker'
