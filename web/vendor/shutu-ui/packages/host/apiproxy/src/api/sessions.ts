...
import type { AttachmentIdType, ImageAttachmentLimits, ImageAttachmentRef, ImageMediaType } from '@shutu-ai/attachment'
import type { ContentBlock } from '@shutu-ai/llm/types'
import type { SessionEvent, SessionId } from '@shutu-ai/session/types'
// The pure-type outlet: api/ is browser-importable, and the package root's
// cordis Context merge (via shutu-agent) must not enter client aggregates.
import type { SessionProjectionMap } from '@shutu-ai/session-projection/types'
import type { RpcId, RpcRequest, RpcResponse } from './rpc.ts'
import type { ToolEventView } from './events.ts'
import type { WorkspaceId } from './workspace.ts'

declare module '@shutu-ai/session-projection/types' {
