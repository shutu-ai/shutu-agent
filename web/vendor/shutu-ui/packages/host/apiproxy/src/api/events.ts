...
import type { AskUserQuestionItem } from '@shutu-ai/user-questions/types'
import type { ApprovalOutcome, ApprovalRequestId } from '@shutu-ai/user-approval/types'
import type { Message } from '@shutu-ai/llm/types'
import type { MessageId } from '@shutu-ai/llm/brand'
import type { CallId } from '@shutu-ai/llm/brand'
import type { JsonValue, SessionEvent, SessionId } from '@shutu-ai/session/types'
import type { ToolCallView, ToolResultView } from '@shutu-ai/tools/presentation'
import type { RpcError, RpcId, RpcRequest } from './rpc.ts'
import type { JobView } from './jobs.ts'
import type { WorkspaceView } from './workspace.ts'

// Client-side consumers take the render-intent vocabulary from the contract;
// shutu-tools remains its owner.
...
export type HostFrame =
   ...
   * owned by `@shutu-ai/api-remotes` (`API_REMOTE_FORWARDED_EVENTS`),
