...
import type { AttachmentIdType, ImageAttachmentLimits, ImageAttachmentRef } from '@shutu-ai/attachment'
 ...
 * the shutu-tools vocabulary into this schema and drift with it.
 */
