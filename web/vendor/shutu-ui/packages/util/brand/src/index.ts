 ...
 *
 * Policy: a package brands the ids it owns — `CallId` in shutu-llm (tool-call
 * correlation), the shared agent/session `SessionId` in shutu-session, and
 * `JobId` in shutu-jobs. Branding is for ids that cross package boundaries and
