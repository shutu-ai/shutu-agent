...
func (a *app) nativeCredentialSet(ctx context.Context, ref, value string) error {
	...
	a.notifyNativeCredentialUpdated(ref)
	return nil
}
...
// notifyNativeCredentialUpdated fans the committed reference change out to
// connected native configuration surfaces. It is safe for apps embedded in
// tests or other hosts that have no native webserver.
func (a *app) notifyNativeCredentialUpdated(ref string) {
	if a.webserver != nil {
		a.webserver.NotifyNativeCredentialUpdated(ref)
	}
}
